...
The yield earned by depositors consists of two components:

- All deposits into the RWI Vault earn a fixed Baseline Yield that accrues programmatically over time and is protected by Nexus Mutual cover. The Baseline Yield is set at 6%.
- Additional bonuses may be earned by locking deposits for longer periods, allowing depositors to participate in excess returns generated by the underlying insurance business.
